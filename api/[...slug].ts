...
router.delete('/dokumen/:id', (req, res) => {
  const { id } = req.params;
...
router.get('/rekap-nas/:siswa_id', (req, res) => {
...
router.get('/nilai-rapor/:siswa_id', (req, res) => {
  const { siswa_id } = req.params;
...
router.post('/nilai-rapor', (req, res) => {
...
router.get('/prestasi/:siswa_id', (req, res) => {
  const { siswa_id } = req.params;
  const filtered = prestasiSiswa.filter(p => p.siswa_id === siswa_id);
  res.json({ status: 'sukses', data: filtered });
});

router.post('/prestasi', (req, res) => {
...
router.post('/tahun-ajaran', (req, res) => {
...
router.put('/tahun-ajaran/:id/aktif', (req, res) => {
  const { id } = req.params;
...
router.delete('/tahun-ajaran/:id', (req, res) => {
  const { id } = req.params;
...
router.post('/jbsuser/login', (req, res) => {
  ...
  if (nip === '2335621999' && password === '331075') {
    res.json({
      ...
      user: {
        ...
        foto: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Murokib',
        is_finance: 1,
        level: 2
      }
    });
...
router.get('/jbsakad/kelas', (req, res) => {
  res.json({
    status: 'sukses',
    source: 'redis',
    total: 13,
    data: [
      { idkelas: 188, nama_kelas: '1A', wali_kelas: 'AMIRUN NISA', hp_wali: '087878562830' },
      { idkelas: 189, nama_kelas: '1B', wali_kelas: 'IKA RAKHMAWATI', hp_wali: '085817586840' },
      { idkelas: 198, nama_kelas: '2A', wali_kelas: 'ERNAWATI', hp_wali: '085771619271' },
      { idkelas: 199, nama_kelas: '2B', wali_kelas: 'MARDIAH', hp_wali: '089685314275' },
      { idkelas: 196, nama_kelas: '3A', wali_kelas: 'SYARIFAH NURJANAH', hp_wali: '085716432910' },
      { idkelas: 197, nama_kelas: '3B', wali_kelas: 'ARIYAH', hp_wali: '089650530215' },
      { idkelas: 194, nama_kelas: '4A', wali_kelas: 'SABA', hp_wali: '08567672837' },
      { idkelas: 195, nama_kelas: '4B', wali_kelas: 'HERI KISWANTO', hp_wali: '081513864491' },
      { idkelas: 192, nama_kelas: '5A', wali_kelas: 'SITI JUARIYAH', hp_wali: '085287932381' },
      { idkelas: 193, nama_kelas: '5B', wali_kelas: 'DESI ARYANI', hp_wali: '085899404504' },
      { idkelas: 190, nama_kelas: '6A', wali_kelas: 'MOH. MUROKIBU W.M', hp_wali: '085959719450' },
      { idkelas: 191, nama_kelas: '6B', wali_kelas: 'FANNY FAJRIAH', hp_wali: '089627901411' },
      { idkelas: 200, nama_kelas: 'AMES', wali_kelas: 'ERWIN OKI FAUZI', hp_wali: '085959719450' }
    ]
  });
});

router.get('/jbsakad/siswa/kelas/:idkelas', (req, res) => {
  res.json({
    status: 'sukses',
    source: 'mysql',
    data: [
      { nis: '1603', nisn: '3130811571', nama: 'AFIFAH NURUL KEISYA', pinsiswa: '55756', hportu: '081316321078', foto: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Afifah' },
      { nis: '1604', nisn: '3131011572', nama: 'AHMAD ZAKI YUSWAN', pinsiswa: '99702', hportu: '08995650496', foto: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Ahmad' },
      { nis: '1605', nisn: '3131211573', nama: 'ALVIRA RIZQIAH NURHASANAH', pinsiswa: '20333', hportu: '087781320699', foto: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Alvira' },
      { nis: '1606', nisn: '3131411574', nama: 'ALYA NABILA', pinsiswa: '72553', hportu: '082338081669', foto: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Alya' },
      { nis: '1607', nisn: '3131611575', nama: 'ANGLING DHARMA', pinsiswa: '40867', hportu: '089501010101', foto: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Angling' },
      { nis: '1608', nisn: '3131811576', nama: 'ARJUNA RASYID PUTRA', pinsiswa: '31334', hportu: '081291971662', foto: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Arjuna' },
      { nis: '1609', nisn: '3132011577', nama: 'AZZEYAAN SHAFIA SETIO', pinsiswa: '66726', hportu: '085726279026', foto: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Azzeyaan' },
      { nis: '1610', nisn: '3132211578', nama: 'BAGAS PUTRA PRAMUDYA', pinsiswa: '69564', hportu: '085771665366', foto: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Bagas' },
      { nis: '1611', nisn: '3132411579', nama: 'DHINO MULYA PRAKOSO', pinsiswa: '93493', hportu: '081280479120', foto: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Dhino' },
      { nis: '1612', nisn: '3132611580', nama: 'ELYSIA VANIA REMU', pinsiswa: '20485', hportu: '085776559108', foto: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Elysia' }
    ]
  });
});

router.get('/jbsakad/nilairapor/siswa/:nis/semester/:semester', (req, res) => {
  res.json({
    status: 'sukses',
    data: [
